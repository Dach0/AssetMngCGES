...
describe('Service Tests', () => {
    describe('AssetStatus Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AssetStatusService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/asset-statuses';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a AssetStatus', () => {
                service.create(new AssetStatus(null)).subscribe(received => {
            ...
            it('should update a AssetStatus', () => {
                service.update(new AssetStatus(123)).subscribe(received => {
            ...
            it('should return a AssetStatus', () => {
