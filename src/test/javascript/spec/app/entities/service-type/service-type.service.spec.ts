    ...
    describe('ServiceType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/service-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ServiceType', () => {
                service.create(new ServiceType(null)).subscribe(received => {
            ...
            it('should update a ServiceType', () => {
                service.update(new ServiceType(123)).subscribe(received => {
            ...
            it('should return a ServiceType', () => {
