    ...
    describe('Qualification Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Qualification', () => {
                service.create(new Qualification(null)).subscribe(received => {
            ...
            it('should update a Qualification', () => {
                service.update(new Qualification(123)).subscribe(received => {
            ...
            it('should return a Qualification', () => {
            ...
            it('should return a list of Qualification', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Qualification(123)]);
            });
