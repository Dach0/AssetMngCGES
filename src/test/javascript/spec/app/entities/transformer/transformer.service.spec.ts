    ...
    describe('Transformer Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/transformers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Transformer', () => {
                service.create(new Transformer(null)).subscribe(received => {
            ...
            it('should update a Transformer', () => {
                service.update(new Transformer(123)).subscribe(received => {
            ...
            it('should return a list of Transformer', () => {
                service.query(null).subscribe(received => {
                    expect(received.body[0].id).toEqual(123);
                });

                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new Transformer(123)]);
            });
