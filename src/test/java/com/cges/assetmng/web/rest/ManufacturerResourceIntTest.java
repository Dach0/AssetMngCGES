...
import com.cges.assetmng.repository.ManufacturerRepository;
...
public class ManufacturerResourceIntTest {
    ...
    private static final String DEFAULT_MANUFACT_NAME = "AAAAAAAAAA";
    private static final String UPDATED_MANUFACT_NAME = "BBBBBBBBBB";
    ...
    public static Manufacturer createEntity(EntityManager em) {
        Manufacturer manufacturer = new Manufacturer()
            .manufactName(DEFAULT_MANUFACT_NAME);
        return manufacturer;
    }
    ...
    public void createManufacturer() throws Exception {
        ...
        assertThat(testManufacturer.getManufactName()).isEqualTo(DEFAULT_MANUFACT_NAME);
    }
    ...
    public void getAllManufacturers() throws Exception {
        ...
        restManufacturerMockMvc.perform(get("/api/manufacturers?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].manufactName").value(hasItem(DEFAULT_MANUFACT_NAME.toString())));
    }
    ...
    public void getManufacturer() throws Exception {
        ...
        restManufacturerMockMvc.perform(get("/api/manufacturers/{id}", manufacturer.getId()))
            ...
            .andExpect(jsonPath("$.manufactName").value(DEFAULT_MANUFACT_NAME.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateManufacturer() throws Exception {
        ...
        updatedManufacturer
            .manufactName(UPDATED_MANUFACT_NAME);
        ...
        Manufacturer testManufacturer = manufacturerList.get(manufacturerList.size() - 1);
        assertThat(testManufacturer.getManufactName()).isEqualTo(UPDATED_MANUFACT_NAME);
    }
